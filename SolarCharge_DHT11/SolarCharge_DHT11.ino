int batteryCapacity = 1000;     //capacity rating of battery in mAh
float resistance = 10.0;     //measured resistance of the power resistor
int cutoffVoltage = 1400;     //maximum battery voltage (in mV) that should not be exceeded
...
int analogPinOne = A0;     //first voltage probe connected to analog pin 1
...
int analogPinTwo = A1;     //second voltage probe connected to analog pin 2
...
int analogPinThree = A2;     //third voltage probe connected to analog pin 2
